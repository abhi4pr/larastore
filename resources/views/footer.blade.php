                ...
                <div class="col-12 col-md-6 col-lg-4 mb-30">
                    <div class="footer-widget mx-w-400">
                        <div class="footer-logo mb-35">
                            <a href="index.html">
                                <img src="{{ URL::asset('img/logo/logo-dark.jpg') }}" alt="footer logo">
                            </a>
                        </div>
                        ...
                        <div class="address-widget mb-30">
                            <div class="media">
                                <span class="address-icon mr-3">
                                    <img src="{{ URL::asset('img/icon/phone.png') }}" alt="phone">
                                </span>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="store d-flex">
                            <a href="https://www.apple.com/" class="d-inline-block mr-3"><img
                                    src="{{ URL::asset('img/icon/apple.png') }}" alt="apple icon"> </a>
                            <a href="https://play.google.com/store/" class="d-inline-block"><img
                                    src="{{ URL::asset('img/icon/play.png') }}" alt="apple icon"> </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="text-left">
                        <img src="{{ URL::asset('img/payment/1.png') }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
...
<!-- modals end -->
    ...
    <script src="{{ URL::asset('css/fontawesome.min.css') }}"></script>
    ...
    <script src="{{ URL::asset('js/addtocart.js') }}"></script>
