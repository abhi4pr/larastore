                                ...
                                <div class="product-desc py-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <form method="POST" action="/addToCart/submit">
                                            @csrf
                                          <input type="hidden" name="pid" value="{{$tuta->id}}">  
                                          <input type="hidden" name="pname" value="{{$tuta->pname}}">  
                                          <input type="hidden" name="pprice" value="{{$tuta->pprice}}">  
                                          <input type="hidden" name="qty" value="1">  
                                          <input type="hidden" name="pimage" value="{{$tuta->pimage}}">
                                          <input type="hidden" name="total_price" value="{{$tuta->pprice}}">
