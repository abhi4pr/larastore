        ...
        <div class="col-lg-5">
          <div class="chart-box">
            ...
            <div class="message-widget"> <a href="#">
              <div class="user-img pull-left"> <img src="{{ URL::asset('admin/img/img1.jpg') }}" class="img-circle img-responsive" alt="User Image"> <span class="profile-status online pull-right"></span> </div>
              ...
              <div class="user-img pull-left"> <img src="{{ URL::asset('admin/img/img3.jpg') }}" class="img-circle img-responsive" alt="User Image"> <span class="profile-status invisable pull-right"></span> </div>
              <div class="mail-contnet">
                <h5>Florence Douglas</h5>
              ...
              <div class="user-img pull-left"> <img src="{{ URL::asset('admin/img/img4.jpg') }}" class="img-circle img-responsive" alt="User Image"> <span class="profile-status offline pull-right"></span> </div>
              <div class="mail-contnet">
                <h5>Florence Douglas</h5>
